          ...
          <div className="mb-8">
            <div className="flex justify-between mb-2">
              {[1, 2, 3].map((s) => (
                <div
                  key={s}
                  className={`h-2 flex-1 mx-1 rounded-full transition-all ${s <= step ? 'bg-gradient-to-r from-blue-600 to-purple-600' : 'bg-gray-200 dark:bg-gray-700'
                    }`}
                />
              ))}
            </div>
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    {['budget', 'moderate', 'luxury'].map((type) => (
                      <button
                        ...
                        className={`p-4 rounded-xl border-2 transition-all ${formData.budgetType === type
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    {interestOptions.map((interest) => (
                      <button
                        ...
                        className={`p-3 rounded-lg border-2 text-sm font-medium transition-all ${formData.interests.includes(interest)
